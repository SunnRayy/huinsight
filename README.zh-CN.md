...
![使用合成数据展示慧眼仪表盘、资产配置报告、WealthOS 与风险矩阵](docs/assets/demo.gif)

*使用慧眼的合成演示账户录制；画面中的所有数字均为合成数据：仪表盘 → 资产配置报告 → WealthOS → 风险矩阵。[观看画质更高的 MP4](docs/assets/demo.mp4)。*
...
- **前端测试套件：267/295 通过。** 这 28 个失败属于「测试与组件不同步」
