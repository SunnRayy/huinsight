...
![Synthetic Huinsight demo showing the Dashboard, Allocation Report, WealthOS, and Risk Matrix](docs/assets/demo.gif)

*Recorded with Huinsight's synthetic demo persona; all figures shown are synthetic: Dashboard → Allocation Report → WealthOS → Risk Matrix. [Watch the higher-quality MP4](docs/assets/demo.mp4).*
...
- **Frontend test suite: 267/295 passing.** The 28 failures are test-vs-component
