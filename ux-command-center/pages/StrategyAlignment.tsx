...
const ScopeSummarySection: React.FC<{ report: StrategyReport }> = ({ report }) => {
    ...
    return (
        <section className="space-y-4">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-300 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg px-4 py-3">
                {t('strategyAlignment.scopeExplanation')}
            </p>
        </section>
    );
};
