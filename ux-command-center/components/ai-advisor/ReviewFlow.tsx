        ...
        <div className="grid gap-5 lg:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)] items-start">
          <div className="rounded-xl border border-slate-200 dark:border-border-dark bg-white dark:bg-card-dark p-6">
            ...
            <button
              ...
              disabled={phase === 'loading-questions' || !periodStart || !periodEnd || llmOff}
      ...
      <div className="w-full py-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            disabled={!allAnswered || phase === 'previewing' || phase === 'generating' || !isPreviewCurrent || llmOff}
            title={llmOff ? t('llmKey.disabledTooltip') : undefined}
      ...
      <div className="w-full py-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            {review.model_used === 'demo-sample' && (
              <p className="text-xs text-slate-400 mt-0.5">{t('demoSample.reviewExplanation')}</p>
            )}
          </div>
          <div className="flex items-center gap-2">
