                ...
                <div className="mt-2 flex items-center justify-between text-xs text-slate-400">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      disabled={!memo.content || llmOff}
                      className={`transition-colors ${memo.content && !llmOff ? 'hover:text-primary dark:hover:text-primary' : 'cursor-not-allowed opacity-50'}`}
                      title={llmOff ? t('llmKey.disabledTooltip') : memo.content ? t('memoManager.proposeUpdates') : t('memoManager.importContentFirst')}
                    >
