...
interface InvestorProfileEditorProps {
  /** Called with the freshly-saved philosophy right after a successful save. */
  onSaved?: (philosophy: InvestorPhilosophy) => void;
}

export const InvestorProfileEditor: React.FC<InvestorProfileEditorProps> = ({ onSaved }) => {
