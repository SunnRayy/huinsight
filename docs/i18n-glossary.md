...
`src/database/mapping_seeds.py`, `config/reference_sheet.example.yaml` (the
real reference_sheet.yaml you create from it is gitignored) and
`seeds/*/reader_mappings/*`
