...
def test_three_manual_dip_buys_in_one_month_raises_alert():
    ...
    # Unscored regardless of the (high) rate — this dimension must never be
    # rewarded or punished via radar geometry; raw_value + alert carry it.
...
def test_no_price_data_buy_excluded_honestly():
    ...
    assert systematic.score is None
