...
class MarketDataScheduler:
    ...
    def _do_refresh(self) -> dict:
        ...
        def refresh_with_connection() -> dict:
        ...
        try:
            return run_guarded_refresh(refresh_with_connection)
        except RefreshInProgress:
            logger.info("MarketDataScheduler: refresh already in progress — skipping")
            return {
                "refreshed": 0,
                "skipped": 0,
                "errors": 0,
                "holdings_updated": 0,
                "deduplicated": True,
                "deduplication_reason": "refresh_in_progress",
            }
