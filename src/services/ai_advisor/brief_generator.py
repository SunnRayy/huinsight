...
from src.services.ai_advisor.context_builder import ContextBuilder, render_context, use_language
...
class BriefGenerator:
    ...
    def generate(
        ...
        if reviewed_context_text is not None:
            ...
            user_prompt = render_context(cb, context_config, language=lang)
