...
def _run_phase3_price_refresh(connector: DatabaseConnector, result: SyncResult) -> None:
    ...
    try:
        ...
        refresh_result = run_guarded_refresh(
            lambda: _MarketDataService().refresh_portfolio_prices(connector),
            force=True,
        )
        ...
        result.warnings.append("Live price refresh skipped: another refresh is already in progress")
        _record_step(result, "live_price_refresh", critical=False, status="skipped",
